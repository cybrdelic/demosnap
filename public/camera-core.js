// Camera core utilities extracted for maintainability
// Provides: buildCamKeys, sampleCamera, buildCamConfig

export function buildCamConfig(camStyle){
...
export function sampleCamera(camKeys, camStyle, ms, CAM){
